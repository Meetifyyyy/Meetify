...
export const communities = {
  design: {
    ...
    goals: ['Share weekly design challenges', 'Build a portfolio review program', 'Host monthly design talks with industry pros'],
    topContributors: [
  ...
  aiml: {
    ...
    goals: ['Run weekly paper reading sessions', 'Build open-source ML projects together', 'Host quarterly AI hackathons'],
    topContributors: [
