export const initialMessages = [
  ...
  {
    id: 4, name: 'Creative Studio', avatar: 'C', color: '#A855F7', online: true,
  ...
  {
    id: 6, name: 'Fintech Labs', avatar: 'F', color: '#06B6D4', online: false,
  ...
  {
    id: 9, name: 'Robotics Alliance Group', avatar: 'R', color: '#EF4444', online: true,
