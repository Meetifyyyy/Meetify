...
export default function ShareCollegeModal({ isOpen, onClose, college }) {
  ...
  const handleCopyLink = () => {
    const link = `${window.location.origin}/colleges/${college.id}`;
    ...
    <div className={styles.overlay} onClick={(e) => { e.stopPropagation(); e.preventDefault(); onClose(); }}>
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        <div className={styles.header}>
          <h2 className={styles.title}>Share College</h2>
