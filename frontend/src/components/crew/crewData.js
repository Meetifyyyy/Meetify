...
const ACTIVITY_TEMPLATES = [
  { category: 'Learning', title: 'Library study session for finals', description: 'Looking for a quiet study session at the main library to prep for finals. Bring your own snacks.', groupSize: 'Small Group', participationType: 'open', tags: ['study', 'quiet'], location: 'Main Library, 2nd Floor', isOnline: false },
  { category: 'Learning', title: 'Group coding practice for interviews', description: 'We will be doing mock interviews and Leetcode pair programming. Good for anyone prepping for software engineering roles.', groupSize: 'Small Group', participationType: 'approval', tags: ['coding', 'interviews'], location: 'Computer Science Building, Room 102', isOnline: false },
  ...
  { category: 'Technology', title: 'Teaming up for HackMIT this weekend', description: 'I have an idea for an AI-powered education tool. Need a frontend dev and designer.', groupSize: 'Small Group', participationType: 'approval', tags: ['hackathon', 'ai'], location: 'MIT Campus', isOnline: false },
  { category: 'Social', title: 'Casual coffee meetup this Saturday', description: 'Just looking to meet new people over some good coffee. No agenda, just vibes.', groupSize: 'Small Group', participationType: 'open', tags: ['coffee', 'casual'], location: 'Blue Bottle Coffee Downtown', isOnline: false },
  { category: 'Sports', title: 'Need 2 players for 3v3 basketball', description: 'We play casually every weekend. Need two more to make it a 3v3.', groupSize: 'Small Group', participationType: 'open', tags: ['basketball', 'sports'], location: 'Campus Rec Center Courts', isOnline: false },
  { category: 'Health & Fitness', title: 'Morning run group around campus', description: 'A slow-paced 5k run around the campus perimeter. All levels welcome.', groupSize: 'Open', participationType: 'open', tags: ['running', 'fitness'], location: 'Main Gate', isOnline: false },
  { category: 'Sports', title: 'Tennis doubles match this weekend', description: 'Looking for an intermediate pair to play against. We have the court booked.', groupSize: 'Small Group', participationType: 'approval', tags: ['tennis', 'doubles'], location: 'City Tennis Club', isOnline: false },
  ...
  { category: 'Health & Fitness', title: 'Gym partner for evening workouts', description: 'Looking for someone to spot me and stay consistent with a PPL split.', groupSize: '1-on-1', participationType: 'approval', tags: ['gym', 'lifting'], location: 'Campus Gym', isOnline: false },
  { category: 'Professional', title: 'Startup founders meetup over lunch', description: 'Casual networking for early-stage founders to share struggles and wins.', groupSize: 'Small Group', participationType: 'approval', tags: ['startup', 'networking'], location: 'Innovation Hub Cafe', isOnline: false },
